//
//  CategoryAnnoucementForCreatingAnnoucement.swift
//  Final Challenge
//
...
class CategoryAnnoucementForCreatingAnnoucement: UIViewController {
    ...
    @IBAction func casaActionButton(_ sender: UIButton) {
        ...
        gravaCategory()
        performSegue(withIdentifier: "unwindFromCategory", sender: self)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "unwindFromCategory" {
            let destinationController =  segue.destination as! CreateAnnoucementViewController
            destinationController.annoucementCategory = categoriaSelecionada
